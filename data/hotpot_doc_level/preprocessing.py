...
#         pad_with_sentence = True
#     else:
#         pad_with_sentence = False
...
#         else:
#             paragraph = trim_paragraph(paragraph, available_length_for_paragraph)
...
out_dict = {'sequence': [], 'start_index':[], 'end_index':[], 'supporting_fact': []}
